...
.PHONY: serve
serve:
	container_id="$$(docker run --rm --init -d -v $$(pwd):/src/site -p 127.0.0.1::4000 naoigcat/github-pages:232 jekyll serve -w --force_polling -H 0.0.0.0 -P 4000)" || { echo 'Failed to start container' >&2 ; exit 1 ; } ; \
