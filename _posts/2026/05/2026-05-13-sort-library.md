...
図書館ソート (`library sort`) は、棚に本を並べるイメージから名付けられた手法で、整列済みデータを隙間（空きスロット）を挟みながら並べ、新しい要素の挿入位置を二分探索で決めて空きへ置く（足りなければ隣接交換でずらす）。

挿入位置の探索に二分探索を使えるため、ランダムな入力では比較回数が `O(n log n)` になりやすく（詳細は隙間の取り方や再配置の戦略に依存する）、古典的な挿入ソートと同じく安定ソートにできる。
...
概念的には「棚に空きを残しておく」ことで、挿入ソートで毎回長いシフトが続く状況を緩和しようとする発想である。
...
|-----------:|----------------:|----------------:|----------------:|----------------:|
|        256 |        0.000007 |        0.000049 |               2 |               2 |
|        512 |        0.000021 |        0.000072 |               4 |               4 |
|       1024 |        0.000051 |        0.000104 |               8 |               8 |
|       2048 |        0.000170 |        0.000271 |              16 |              16 |
|       4096 |        0.000564 |        0.001019 |              32 |              32 |
|       8192 |        0.002039 |        0.003697 |              64 |              64 |
|      16384 |        0.007382 |        0.014143 |             128 |             128 |
|      32768 |        0.030925 |        0.045645 |             256 |             256 |
|      65536 |        0.137635 |        0.944711 |             512 |             512 |
|     131072 |        0.582154 |        0.815700 |            1024 |            1024 |
|     262144 |        2.716857 |        6.229811 |            2048 |            2048 |
