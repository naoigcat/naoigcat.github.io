...
[ヒープソート](/2026/05/04/sort-heap.html)や[スプレイソート](/2026/07/08/sort-splay.html)も木経由だが、ツリーソートは平衡でない二分探索木への挿入順に形が依存する。[デカルト木ソート](/2026/05/22/sort-cartesian-tree.html)は配列から一意に木が定まる。
