...
1.  **木の準備**: 要素数 `n` 以上の2の冪 `k` の葉を持つ配列 `tree` を用意する。葉 `tree[k+i]` にはインデックス `i`（$$i \ge n$$ の余りは無効）を入れる。
...
選択ソートより比較回数を抑えられ、全体で $$O(n \log n)$$ 程度だが、トーナメント木に $$O(n)$$ の追加領域が要り、不安定である。
...
|-----------:|-----------------:|-----------------:|---------------------:|---------------------:|
|        256 |         0.000008 |         0.000040 |                    6 |                    6 |
|        512 |         0.000018 |         0.000059 |                   12 |                   12 |
|       1024 |         0.000038 |         0.000078 |                   24 |                   24 |
|       2048 |         0.000083 |         0.000237 |                   48 |                   48 |
|       4096 |         0.000181 |         0.000421 |                   96 |                   96 |
|       8192 |         0.000402 |         0.000733 |                  192 |                  192 |
|      16384 |         0.000898 |         0.001434 |                  384 |                  384 |
|      32768 |         0.001984 |         0.003471 |                  768 |                  768 |
|      65536 |         0.004484 |         0.007122 |                 1536 |                 1536 |
|     131072 |         0.010212 |         0.014253 |                 3072 |                 3072 |
|     262144 |         0.023062 |         0.035707 |                 6144 |                 6144 |
