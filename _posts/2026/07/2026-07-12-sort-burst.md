...
本記事では整数キーを十進桁ごとに扱う簡略版を示す。[トライソート](/2026/07/11/sort-trie.html)と同様に最上位桁優先の区分付けだが、最初から木全体を構築するのではなく、バケットが膨らんだときだけ子ノードへ展開する点が異なる。
...
桁数を `w` とすると挿入と収集はともに $$O(n \cdot w)$$ であり、補助記憶域は $$O(n)$$ となる。葉バケットを挿入ソートで仕上げるため安定ソートである。
...
|-----------:|----------------:|----------------:|----------------:|----------------:|
|        256 |        0.000013 |        0.000071 |               8 |               8 |
|        512 |        0.000023 |        0.000556 |              16 |              16 |
|       1024 |        0.000045 |        0.000107 |              32 |              32 |
|       2048 |        0.000089 |        0.000358 |              64 |              64 |
|       4096 |        0.000171 |        0.000320 |             129 |             129 |
|       8192 |        0.000344 |        0.001521 |             259 |             259 |
|      16384 |        0.000662 |        0.001296 |             517 |             517 |
|      32768 |        0.001319 |        0.002828 |            1035 |            1035 |
|      65536 |        0.003314 |        0.006463 |            2070 |            2070 |
|     131072 |        0.006495 |        0.011993 |            4141 |            4141 |
|     262144 |        0.016188 |        0.052878 |            8283 |            8283 |
