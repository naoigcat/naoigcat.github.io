...
[ロムート分割型クイックソート](/2026/05/02/sort-quick-lumoto.html)が要素値そのものをピボットにするのに対し、こちらは「現在見ているビットが 0 か 1 か」が分割の基準になる。分割の形はクイックソートに近く、桁の扱い方は MSD（最上位桁優先）の[基数ソート](/2026/06/21/sort-radix.html)や[アメリカ国旗ソート](/2026/07/02/sort-american-flag.html)に近い。
