...
[通常のクイックソート](/2026/05/02/sort-quick.html)が 2 分割だけだと等値キーが多いときに再帰が深くなるのに対し、こちらは等値帯をその場で確定できるため、重複の多い入力で有利になりやすい。
...
[クイックソート](/2026/05/02/sort-quick.html)は 1 ピボットで 2 分割するが、等値を左右どちらに寄せるかの規約に依存し、重複が多いと偏りやすい。
