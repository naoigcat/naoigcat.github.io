...
1 パスあたりの比較回数はおおよそ $$O(n \log n)$$ で、パス回数は典型的に $$O(\log n)$$ 程度とされるため、全体は $$O(n \log^2 n)$$ 前後になる。補助配列は使わず、再帰の深さは $$O(\log n)$$ である。一般に不安定である。
...
[ロムート分割型クイックソート](/2026/05/02/sort-quick-lomuto.html)はピボットで区間を分割するが、サークルソートの直径比較はピボット値を選ばず、両端から内側へ向かう固定パターンで入れ替えるだけである。
...
|-----------:|----------------:|----------------:|----------------:|----------------:|
|        256 |        0.000026 |        0.000120 |               0 |               0 |
|        512 |        0.000061 |        0.000495 |               0 |               0 |
|       1024 |        0.000140 |        0.000343 |               0 |               0 |
|       2048 |        0.000322 |        0.001391 |               0 |               0 |
|       4096 |        0.000505 |        0.000956 |               0 |               0 |
|       8192 |        0.001035 |        0.001897 |               0 |               0 |
|      16384 |        0.002327 |        0.004187 |               0 |               0 |
|      32768 |        0.005128 |        0.009745 |               0 |               0 |
|      65536 |        0.010830 |        0.019937 |               0 |               0 |
|     131072 |        0.023429 |        0.045551 |               0 |               0 |
|     262144 |        0.049744 |        0.077279 |               0 |               0 |
