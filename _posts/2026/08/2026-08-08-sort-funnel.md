...
通常の[マージソート](/2026/05/03/sort-merge.html)も比較回数は `O(n log n)` だが、二入力マージを浅い再帰で繰り返すと、作業集合がキャッシュに収まりきらない段階で転送が膨らみやすい。
...
3.  **遅延 k 入力マージャ**: `k` 本の整列済みストリームを、二入力マージャの完全二分木で併合する。各内部ノードは出力バッファを持ち、バッファが空（または半分未満）になったときだけ子マージャを再帰的に呼び出して補充する（lazy fill）。
...
[マージソート](/2026/05/03/sort-merge.html)は区間を半分に分け二入力マージを重ねる。ファンネルソートはブロック数を `n^{1/3}` 前後に取り、遅延 k 入力マージャのバッファ階層で併合順を制御する点が異なる。
...
|-----------:|----------------:|----------------:|----------------:|----------------:|
|        256 |        0.000015 |        0.000082 |              70 |              76 |
|        512 |        0.000038 |        0.000104 |              78 |              84 |
|       1024 |        0.000083 |        0.000290 |              86 |              92 |
|       2048 |        0.000175 |        0.000523 |             101 |             108 |
|       4096 |        0.000331 |        0.002476 |             130 |             136 |
|       8192 |        0.000719 |        0.004079 |             142 |             148 |
|      16384 |        0.001937 |        0.011934 |             235 |             276 |
|      32768 |        0.003832 |        0.013313 |             491 |             532 |
|      65536 |        0.008529 |        0.023747 |            1020 |            2396 |
|     131072 |        0.027481 |        0.067488 |            2027 |            2068 |
|     262144 |        0.046291 |        0.095529 |            4071 |            4112 |
