...
1.  **値域の決定**: 配列の最小値 `min` と最大値 `max` から、バケット数 `m`（多くは `n` や $$\sqrt{n}$$）と区間幅を決める。
...
分布が一様なら $$O(n)$$ に近づくが、同一バケットに偏ると内部ソート分だけ遅くなる。各バケット内の整列と連結が安定なら、全体も安定ソートにできる。
...
|-----------:|-----------------:|-----------------:|---------------------:|---------------------:|
|        256 |         0.000011 |         0.000134 |                   14 |                   14 |
|        512 |         0.000021 |         0.000115 |                   28 |                   28 |
|       1024 |         0.000040 |         0.000184 |                   56 |                   56 |
|       2048 |         0.000085 |         0.000243 |                  112 |                  112 |
|       4096 |         0.000212 |         0.001231 |                  224 |                  224 |
|       8192 |         0.000322 |         0.000703 |                  448 |                  448 |
|      16384 |         0.000567 |         0.001511 |                  896 |                  896 |
|      32768 |         0.000955 |         0.002118 |                 1792 |                 1792 |
|      65536 |         0.002333 |         0.006537 |                 3584 |                 3584 |
|     131072 |         0.004455 |         0.012668 |                 7168 |                 7168 |
|     262144 |         0.010922 |         0.043858 |                14336 |                14336 |
